...
public class PurchaseView extends JFrame {
  ...
  public PurchaseView(String title) {
    super(title);
...
//    this.setVisible(true);
  ...
  public void changeSellerInfo(String name, String phoneNumber) {
  ...
  private void setSelectAndReturnButton() {
    selectButton = new JButton("구매하기");
    returnButton = new JButton("돌아가기");

    selectButton.setBounds(100, 300, 100, 40);
